...
from src.cache.news_cache import get_cached_categories, set_cache_categories, get_cached_news_list, set_cache_news_list
...
async def get_related_news(db:AsyncSession,news_id,category_id,limit:int=5):
